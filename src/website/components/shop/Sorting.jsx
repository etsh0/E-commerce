  ...
  return (
    <>
        <div className="relative w-50" id="dropdwon">
            <button className="flex items-center justify-between w-full bg-gray-100 rounded-xl py-2 px-3 cursor-pointer" id="dropdownBtn">
                <span className="text-xs md:text-sm uppercase text-text" id="selectedText">Sort By</span>
                <img src={arrowDown} alt="" />
            </button>
            {/* <!-- options --> */}
            <ul className="absolute top-12 left-0 w-full bg-white border border-gray-200 rounded-xl shadow-lg text-sm md:text-[15px] flex flex-col gap-1 px-1 py-3 cursor-pointer hidden overflow-hidden" id="dropdownMenu">
