...
export const MenuBar = () => {
  ...
  return (
    <>
        ...
        <div className={`sideBar w-full md:w-80 h-screen bg-white shadow-lg fixed top-0 left-0 z-100 transform transition-transform duration-300 ease-in-out lg:hidden ${isMenuOpen ? "translate-x-0" : "-translate-x-300"}`}>
